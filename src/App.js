...
export default function App() {
  return (
    <Wrapper>
      <Spline className="spline" scene="https://prod.spline.design/s0u3NY25Bf6Zw9dr/scene.splinecode" />
      <Content>
        <Menu>
        ...
        <button><img src={IconLaptop} alt="laptop-icon" /> Download for Mac</button>
      </Content>
      <Social>
        <div />
